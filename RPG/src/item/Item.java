...
public class Item {
    ...
    public Item(Integer id, String nome, Float acrescimo_hp, Float decrescimo_hp, Float acrescimo_a, Float decrescimo_a, Float acrescimo_d, Float decrescimo_d, Boolean status, String tipo) {
        this.id = id;
        this.nome = nome;
